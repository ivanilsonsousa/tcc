...
export const LoadingTower = () => {

  return (
    <div className="wrapper-loadin-tower fixed inset-0 bg-slate-400 bg-opacity-60 backdrop-blur-sm z-50 flex items-center justify-center" >
      <div className="w-screen h-screen flex flex-col justify-center" >
        ...
        <div className="message">
          <p className="message__line">Enviando dados...</p>
          <p className="message__line">Juntando as peças…</p>
          <p className="message__line">Gerando a documentação baseada no contexto geral…</p>
          <p className="message__line">Extraindo o código…</p>
          <p className="message__line">Analisando indícios…</p>
          <p className="message__line">Estamos trabalhando o mais rápido possível…</p>
          <p className="message__line">Isso pode levar algum tempo…</p>
          <p className="message__line">Quase lá…</p>
        </div>
      </div>
    </div>
  );
